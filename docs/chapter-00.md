...
Welcome to the "My First Language Frontend with MLIR" tutorial. Here we
...
fast and show a concrete example of something that uses MLIR to generate
code.
...
- [Chapter #1: Kaleidoscope language and Lexer](chapter-01.md) -
...
- [Chapter #5: Extending the Language: Control Flow](chapter-05.md) - With
  ...
  flow.
- [Chapter #6: Extending the Language: User-defined Operators](chapter-06.md) - This chapter extends the language to let
...
- [Chapter #7: Extending the Language: Mutable Variables](chapter-07.md) - This chapter talks about adding user-defined local
...
- [Chapter #8: Compiling to Object Files](chapter-08.md) - This
  chapter explains how to take LLVM IR and compile it down to object
  files, like a static compiler does.
- [Chapter #9: Debug Information](chapter-09.md) - A real language
...
- [Chapter #10: Conclusion and other tidbits](chapter-10.md) - This
