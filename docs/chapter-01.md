...
A more interesting example is included in Chapter 6 where we write a little Kaleidoscope application that [displays a Mandelbrot Set](chapter-06.md#kicking-the-tires) at various levels of magnification.
